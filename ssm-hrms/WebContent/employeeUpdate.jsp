    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary emp_update_btn">更新</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<script type="text/javascript">
    ...
    $(".emp_edit_btn").click(function () {
        ...
        $("#update_department").empty();//遍历之前，清空一次
        //2 部门回显列表；
        $.ajax({
            url:"getDeptName",
            type:"GET",
    ...
    $(".emp_update_btn").click(function () {
        ...
        $.ajax({
            ...
            success:function (result) {
                if (result.code==100){
                    alert("员工更改成功！");
                    $(".emp-update-modal").modal("hide");//关闭模态框
                    //跳转到当前页
